...
static const int PST_KNIGHT_OPENING[8][10] ={
    {0, -50, -40, -30, -30, -30, -40, -50, 0, 0},
    {0, -40, -20, 5, 0, 0, -20, -40, 0, 0},
    {0, -30, 10, 15, 15, 15, 10, -30, 0, 0},
    {0, -30, 5, 20, 20, 20, 5, -30, 0, 0},
    {0, -30, 5, 20, 20, 20, 5, -30, 0, 0},
    {0, -30, 10, 15, 15, 15, 10, -30, 0, 0},
    {0, -40, -20, 5, 0, 0, -20, -40, 0, 0},
    {0, -50, -40, -30, -30, -30, -40, -50, 0, 0}
...
static const int PST_BISHOP_OPENING[8][10] ={
    {0, -20, -10, -10, -10, -10, -10, -20, 0, 0},
    {0, -10, 5, 0, 0, 0, 5, -10, 0, 0},
    {0, -10, 10, 10, 10, 10, 10, -10, 0, 0},
    {0, -10, 5, 15, 15, 15, 5, -10, 0, 0},
    {0, -10, 5, 15, 15, 15, 5, -10, 0, 0},
    {0, -10, 10, 10, 10, 10, 10, -10, 0, 0},
    {0, -10, 5, 0, 0, 0, 5, -10, 0, 0},
    {0, -20, -10, -10, -10, -10, -10, -20, 0, 0}
...
static const int PST_QUEEN_OPENING[8][10]={
    {0, -20, -15, -10, -5, -5, -10, -15, -20, 0},
    {0, -15, 0, 0, 0, 0, 0, 0, -10, 0},
    {0, -10, 0, 0, 5, 5, 0, 0, -10, 0},
    {0, -10, 0, 5, 5, 5, 5, 0, -10, 0},
    {0, -10, 0, 5, 5, 5, 5, 0, -10, 0},
    {0, -10, 0, 0, 5, 5, 0, 0, -10, 0},
    {0, -15, -10, 0, 0, 0, 0, -10, -15, 0},
    {0, -20, -15, -10, -5, -5, -10, -15, -20, 0}
};

static const int PST_KING_OPENING[8][10]={
{  0, 30,  40,  10,   0,   0,  10,  40,  30,  0 },
...
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 },
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 },
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 },
{  0,  0,  10,  15,  25,  50,  80,   0,   0,  0 },
{  0,  0,  10,  15,  25,  50,  80,   0,   0,  0 },
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 },
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 },
{  0,  0,   5,  10,  20,  40,  70,   0,   0,  0 }
...
{  0,-40, -20, -10, -10, -10, -20, -40,   0,  0 },
{  0,-20,   0,  10,  10,  10,   0, -20,   0,  0 },
{  0,-10,  10,  20,  20,  20,  10, -10,   0,  0 },
{  0,-10,  10,  20,  25,  25,  10, -10,   0,  0 },
{  0,-10,  10,  20,  25,  25,  10, -10,   0,  0 },
{  0,-10,  10,  20,  20,  20,  10, -10,   0,  0 },
{  0,-20,   0,  10,  10,  10,   0, -20,   0,  0 },
{  0,-40, -20, -10, -10, -10, -20, -40,   0,  0 }
...
{  0,-10,  -5,  -5,  -5,  -5,  -5, -10,   0,  0 },
{  0, -5,   5,   5,   5,   5,   5,  -5,   0,  0 },
{  0, -5,   5,  10,  10,  10,   5,  -5,   0,  0 },
{  0, -5,   5,  10,  15,  15,   5,  -5,   0,  0 },
{  0, -5,   5,  10,  15,  15,   5,  -5,   0,  0 },
{  0, -5,   5,  10,  10,  10,   5,  -5,   0,  0 },
{  0, -5,   5,   5,   5,   5,   5,  -5,   0,  0 },
{  0,-10,  -5,  -5,  -5,  -5,  -5, -10,   0,  0 }
...
{  0,-20, -10,  -5,  -5,  -5, -10, -20,   0,  0 },
{  0,-10,   5,  10,  10,  10,   5, -10,   0,  0 },
{  0, -5,  10,  20,  20,  20,  10,  -5,   0,  0 },
{  0, -5,  10,  20,  25,  25,  10,  -5,   0,  0 },
{  0, -5,  10,  20,  25,  25,  10,  -5,   0,  0 },
{  0, -5,  10,  20,  20,  20,  10,  -5,   0,  0 },
{  0,-10,   5,  10,  10,  10,   5, -10,   0,  0 },
{  0,-20, -10,  -5,  -5,  -5, -10, -20,   0,  0 }
